import { BalancedRedistributionDialogComponent } from './../pms/modals/balanced-redistribution-dialog/balanced-redistribution-dialog.component';
...
import { ppmTasksComponent } from './ppm-tasks.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild([
      {
        path: 'PPMNotCompleted',
        data: { PPMCompleted: false , isSoftService : false  },
        component: ppmTasksComponent,
      },
      {
        path: 'SoftServiceTasks',
        data: { PPMCompleted: false , isSoftService : true },
        component: ppmTasksComponent,
      },
      {
        path: 'PPMCompleted',
        data: { PPMCompleted: true ,  CompletedSST : false },
        component: ppmTasksComponent,
      },
      {
        path: 'CompletedSST',
        data: { PPMCompleted: true , CompletedSST : true},
        component: ppmTasksComponent,
      },
      {
        path: 'card/:id',
