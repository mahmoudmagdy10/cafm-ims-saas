...
import { FieldsAsAssetIdToPmsComponent } from './fields-as-asset-id/fields-as-asset-id.component';
import { AddInstructionToPmsComponent } from './add-instruction/addInstruction.component';
import { PmsService } from 'src/app/pages/pms/pms.service';
import { environment } from 'src/environments/environment';

@Component({
  selector: 'edit-instructionPMS',
  templateUrl: './editInstruction.component.html',
  styleUrls: ['./editInstruction.component.scss'],
  providers: [treeService],
})
export class EditInstructionToPmsComponent implements OnInit {
  ...
  addInstruction() {
    ...
    const dialogRef = this.dialog
      .open(AddInstructionToPmsComponent, {
        width: '40vw',
        data: {},
        disableClose: true,
      })
  ...
  LinkWithFieldInAsset(Assets: any, fieldType: any, dataInst: any) {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result) {
        const FieldDialogRef = this.dialog.open(FieldsAsAssetIdToPmsComponent, {
          width: '50vw',
