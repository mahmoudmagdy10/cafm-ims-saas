...
import { EventReportingClassificationComponent } from './event-reporting-classification/event-reporting-classification.component';


@NgModule({
  declarations: [
    EventReportingClassificationComponent,
...
export class EventReportingClassificationModule { }
