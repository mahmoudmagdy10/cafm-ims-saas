...
import { BROWSER_STORAGE } from './../../modules/auth/services/storage.service';
...
import { BrowserStorageService } from 'src/app/modules/auth/services/storage.service';
...
export class AccidentReportsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public service: AccidentReportsService,
