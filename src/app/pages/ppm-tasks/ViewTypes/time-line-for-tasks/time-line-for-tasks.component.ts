...
export class TimeLineForTasksComponent implements OnInit {
  constructor(public service: ppmTasksService, private toastr: ToastrService) {}
  ...
  calendarOptions: CalendarOptions = {
    ...
    eventContent: function (arg: any) {
      ...
      return {
        html: `<div class="progress" style='height: 35px; background-color:${
          arg.event.extendedProps.colorCompltion + '33'
        };
            '>
            <div class="progress-bar"
             ...
             background-color:${arg.event.extendedProps.colorCompltion}"
              aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">${
                arg.event.extendedProps.CompletionRatio
              }</div>
          </div>
        `,
      };
