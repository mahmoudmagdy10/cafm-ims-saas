...
import { UsersAndTeamsService } from '../../ppm-tasks/modals/filter-for-print-pdf/User&TeamsModal/user&TeamsModal.service';
...
export class ReportWorkOrderPdfComponent implements OnInit {
  ...
  constructor(private _workOrderService: workOrderService, private usersAndTeamsService: UsersAndTeamsService) {}
